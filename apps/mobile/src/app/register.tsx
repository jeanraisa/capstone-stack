...
import { useSignInWithAppleMutation, useSignUpMutation } from "~/hooks/user";
...
export default function Register() {
  ...
  const signUpMutation = useSignUpMutation({ onError: setError });
  const signInWithApple = useSignInWithAppleMutation();

  const disabled = signUpMutation.isPending || signInWithApple.isPending;
                  ...
                  if (e instanceof Object && "code" in e) {
                    ...
                    switch (code) {
                      ...
                      case "ERR_REQUEST_CANCELED":
                        setError("The authorization request canceled.");
                        break;
                      default:
